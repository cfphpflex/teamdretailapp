...
npm install -g npm > ~/RSA-Mono-Site/logs/npm.txt 2>&1
printf "Completed.\n"

printf "Installing monolith dependencies..."
cd ./monolith
npm install > ~/RSA-Mono-Site/logs/monolith.txt 2>&1
printf "Completed.\n"

printf "Installing microservies dependencies..."
cd ../microservices
npm install > ~/RSA-Mono-Site/logs/microservices.txt 2>&1
printf "Completed.\n"

printf "Installing React app dependencies..."
cd ../react-app
npm install > ~/RSA-Mono-Site/logs/react.txt 2>&1
printf "Completed.\n"

printf "Building React app and placing into sub projects..."
npm run build > ~/RSA-Mono-Site/logs/build.txt 2>&1
printf "Completed.\n\n"
